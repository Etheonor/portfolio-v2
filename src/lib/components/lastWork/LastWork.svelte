<script lang="ts">
	...
	import Multy from '$lib/assets/images/multy.png?enhanced';
	import Travelogue from '$lib/assets/images/travelogue.png?enhanced';
	import Geo from '$lib/assets/images/geovadrouille.png?enhanced';
</script>
